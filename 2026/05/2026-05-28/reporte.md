# Reporte de Procesamiento — 2026-05-28

**Fecha y hora (Bogota):** 2026-05-28 20-43-37

**Estado:** ❌ ERROR

**Carpeta historial:** `2026-05-28_20-43-37`

## ⚠️ Errores detectados

- Script 2 (Bancos): revisar que los archivos sean del mismo periodo y banco. [line 91]
...
```json
{
  "script1": {
    "script1_status": "ok",
    "script1_paso1_id": "1WEcT1D0qCx_sEIXkML5alUQwpfZPv4Sb",
    "script1_paso1_name": "paso1_Recargas Concesionario Yopago.xlsx",
    "script1_error": null,
    "script1_raw": "{\"kind\":\"drive#file\",\"id\":\"1WEcT1D0qCx_sEIXkML5alUQwpfZPv4Sb\",\"name\":\"paso1_Recargas Concesionario Yopago.xlsx\",\"mimeType\":\"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\",\"starred\":false,\"trashed\":false,\"explicitlyTrashed\":false,\"parents\":[\"1qulBT2VmQn1XL6cK1kednqiTSWzcO0Dq\"],\"spaces\":[\"drive\"],\"version\":\"3\",\"webContentLink\":\"https://drive.google.com/uc?id=1WEcT1D0qCx_sEIXkML5alUQwpfZPv4Sb&export=download\",\"webViewLink\":\"https://docs.google.com/spreadsheets/d/1WEcT1D0qCx_sEIX"
  },
  "script2": {
    "script1_status": "ok",
    "script1_paso1_id": "1WEcT1D0qCx_sEIXkML5alUQwpfZPv4Sb",
    ...
    "script2_error": "revisar que los archivos sean del mismo periodo y banco. [line 91]",
    "script2_raw": "{\"error\":\"revisar que los archivos sean del mismo periodo y banco. [line 91]\"}"
  },
  "script3": {
    "script1_status": "ok",
    "script1_paso1_id": "1WEcT1D0qCx_sEIXkML5alUQwpfZPv4Sb",
    ...
    "timestamp": "2026-05-29T01:44:25.606Z",
